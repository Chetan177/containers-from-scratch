...
- [Linux namepsaces in Go](https://songrgg.github.io/programming/linux-namespace-part01-uts-pid/). ([Demo code](https://github.com/songrgg/namespace-demo))
...
- [RHEL doc - Introduction to cgroups](https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/6/html/resource_management_guide/ch01)
